    ...
    <div class="container position-absolute top-50 start-50 translate-middle">
        <div class="card order_total shadow m-auto p-3 col-xxl-4 h-75">
                    ...
                    if (isset($_POST['submit'])) 
                    {
                        ...
                        foreach($_POST["order"] as $key => $order)
                        {
                                ...
                                {   
                                    ...
                                    mysqli_query($con,"INSERT INTO `order_list`(`order_id`, `order`, `table_num_order`, `status`) VALUES ('$id','$forder','3','Pending')");
            ...
            <div class="col-12">
                ...
                <a type="button" name="submit" href="customer_side3.php" class="btn btn-dark">
                    Order Now
                </a>
        </div>
    </div>
